...
const StopInfo = props => {
    ...
    return (
        <div class={styles.stopInfoContainer}>
            ...
            <p>If you are unsure of how to take transit, you may be eligible for the <a target={"_blank"} rel="noopener noreferrer" href="https://rideconnection.org/services/travel-training">RideWise Travel Training Program</a>.</p>
            <p>Call Ride Connection at 503-226-0700 or TTY: 7-1-1 (Oregon Relay Service) to learn more about travel training or other services</p>
            <p><a target={"_blank"} rel="noopener noreferrer" href="https://trimet.org/lowincome/index.htm">TriMet's Reduced Fare Program</a></p>
        </div>
    );
}
